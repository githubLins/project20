...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper = new Wordsdatabase(this);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        getMenuInflater().inflate(R.menu.wordslistmenu, menu);
    }
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_update:
                ...
                textMeaning = (TextView) itemView.findViewById(R.id.MeanView);
    ...
    private void setWordsListView(ArrayList<Map<String, String>> items) {
        SimpleAdapter adapter = new SimpleAdapter(this, items, R.layout.item,
                ...
                new int[]{R.id.text, R.id.WordView, R.id.MeanView, R.id.SampleView});
    ...
    private void Insert(String strWord, String strMeaning, String strSample) {
        ...
        values.put(Words.Word.Column_name_mean, strMeaning);
    ...
    private void InsertDialog() {
        final RelativeLayout relativeLayout = (RelativeLayout) getLayoutInflater().inflate(R.layout.activity_insert, null);
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String strMeaning = ((EditText) relativeLayout.findViewById(R.id.mean)).getText().toString();
    ...
    private void UpdateDialog(final String strId, final String strWord, final String strMeaning, final String strSample) {
        ...
        ((EditText) relativeLayout.findViewById(R.id.mean)).setText(strMeaning);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String strNewMeaning = ((EditText) relativeLayout.findViewById(R.id.mean)).getText().toString();
    ...
    private void SearchDialog() {
        final TableLayout tableLayout = (TableLayout) getLayoutInflater().inflate(R.layout.search_word, null);
        new AlertDialog.Builder(this)
                .setTitle("查找单词")//标题
